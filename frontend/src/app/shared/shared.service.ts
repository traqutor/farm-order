...
export class SharedService {
  ...
  getUserAssignedFarms(): Observable<{ results: Array<Farm>, resultsCount: number }> {
    return this.http.get<{ results: Array<Farm>, resultsCount: number }>(`${this.apiUrl}/api/Farm/GetUserAssignedFarms`);
  }
